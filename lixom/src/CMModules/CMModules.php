<?php
/**
* A model for managing Lixom modules.
* 
* @package LixomCore
*/
class CMModules extends CObject {
   ...
   * Properties
   */
  private $lixomCoreModules = array('CLixom', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $lixomCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isLixomCore']   		= in_array($rc->name, $this->lixomCoreModules);
      $details['isLixomCMF']    		= in_array($rc->name, $this->lixomCMFModules);
