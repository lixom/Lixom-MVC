<?
/**
* Main class for Lixom, holds everything.
*
* @package LixomCore
*/
class CLixom implements ISingleton {
  ...
  public $user;
   ...
   protected function __construct() {
     ...
     $lix = &$this;
     require(LIXOM_SITE_PATH.'/config.php');
    ...
    * @return CLixom The instance of this class.
    */
   public static function Instance() {
     if(self::$instance == null) {
       self::$instance = new CLixom();
     }
  ...
  public function FrontControllerRoute() {
    ...
    if($controllerExists && $controllerEnabled && $classExists) {
      ...
      die('404. Page is not found. (Make sure it exists and is enabled)');
    }
  ...
  public function ThemeEngineRender() {
    ...
    $themePath  = LIXOM_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = LIXOM_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    include(LIXOM_INSTALL_PATH . '/themes/functions.php');
