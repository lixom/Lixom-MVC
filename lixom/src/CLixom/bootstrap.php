...
function exception_handler($exception) {
  echo "Lixom: Uncaught exception: <p>" . $exception->getMessage() . "</p><pre>" . $exception->getTraceAsString(), "</pre>";
}
...
function htmlent($str, $flags = ENT_COMPAT) {
  return htmlentities($str, $flags, CLixom::Instance()->config['character_encoding']);
}
